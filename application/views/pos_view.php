...
<a href="<?php echo base_url('inventory') ?>"><button style="float: left; margin-top: 6px; margin-left: 20px; margin-right: 20px;" class="btn btn-warning btn-lg"  >Back To Inventory</button></a>
<a href="<?php echo base_url('logout/out') ?>"><button style="float: right; margin-top: 6px; margin-right: 20px;" class="btn btn-primary btn-lg"  >Sign Out</button></a>
	<div style="padding-left: 20px; padding-top: 2px;">
		...
		<p style="margin: 0;">By: Md.Ruhul Amin</p>
	</div>
</header>
<div class="main">
